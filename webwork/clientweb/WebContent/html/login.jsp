...
<body>
<% String id=""; %>
	<form name="login_frm" action="/clientweb/login.do" method="post">
															...
															<tr>
																<td>
																	<table cellpadding="0" cellspacing="0" border=0>
																		...
																		<tr>
																			<td colspan=3><img
																				src="/clientweb/images/page_login.gif"></td>
																		</tr>
																		<tr>
																			<td height=25></td>
																		</tr>
																		<tr>
																			<td background="/clientweb/images/inputBg.gif"><img
																				src="/clientweb/images/login_id.gif"></td>
																			<td background="/clientweb/images/inputBg.gif"><input
																				type="text" name="id" size="15" class="grayinput"
																				tabindex=1 style="width: 156;"
																				 value="<%= id%>"></td>
																			<td rowspan=3 style="padding-left: 10" valign=bottom>
																			<input
																				type='image' src="/clientweb/images/btn_login.gif"
																		...
																		<tr>
																			<td background="/clientweb/images/inputBg.gif"><img
																				src="/clientweb/images/login_pass.gif"></td>
																			<td background="/clientweb/images/inputBg.gif"><input
